...
export default function ReactCodeRunner({
  ...
  return (
    <SandpackProvider
      key={code}
      template="react-ts"
      className="relative h-full w-full font-pixel [&_.sp-preview-container]:flex [&_.sp-preview-container]:h-full [&_.sp-preview-container]:w-full [&_.sp-preview-container]:grow [&_.sp-preview-container]:flex-col [&_.sp-preview-container]:justify-center [&_.sp-preview-iframe]:grow"
      files={{
        "App.tsx": code,
        ...shadcnFiles,
        "/tsconfig.json": {
